...
namespace Jenga.Core
{
    ...
    public class Camera : GameComponent
    {
        ...
        public Camera(Game game)
            : base(game)
        {
            widthOver2  = game.GraphicsDevice.DisplayMode.Width / 2;
            heightOver2 = game.GraphicsDevice.DisplayMode.Height / 2;
            aspectRatio = (float)game.GraphicsDevice.DisplayMode.Width / (float)game.GraphicsDevice.DisplayMode.Height;
            UpdateProjection();
